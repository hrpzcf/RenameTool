...
@click.group()
@click.option(
    '-v', default=None, help='Show the version information of RenameTool.'
)
def main(v):
...
@click.option(
    '--pat', default=None, help='Regular expression used to match strings.'
)
@click.option(
    '--repl',
    default=None,
