...
class Ui_rentwd(object):
    ...
    def retranslateUi(self, rentwd):
        ...
        rentwd.setWindowTitle(_translate("rentwd", "批量重命名工具 2020.0413.00 alpha"))
...
"数字序号：填写格式：<起始.步长.宽度>，可与普通字符组合，如 <0.1.3>~，则按 000~、001~、002~、003~…添加序号。"))
        ...
        self.checkBox.setStatusTip(_translate("rentwd", "未来得及完成的功能。"))
        ...
        self.btn_LNR_ClearLog.setText(_translate("rentwd", "删除最早记录"))
