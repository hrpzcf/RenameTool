...
class Ui_RenameToolUI(object):
    def setupUi(self, RenameToolUI):
        ...
        font.setPointSize(9)
        self.lineEdit_ReplSrc.setFont(font)
        ...
        font.setFamily("Consolas")
        font.setPointSize(9)
        self.lineEdit_ReplWith.setFont(font)
        ...
        font.setFamily("Consolas")
        font.setPointSize(9)
        self.lineEdit_RReplLB.setFont(font)
        ...
        font.setFamily("Consolas")
        font.setPointSize(9)
        self.lineEdit_RReplRB.setFont(font)
        ...
        font.setFamily("Consolas")
        font.setPointSize(9)
        self.lineEdit_RReplWith.setFont(font)
        ...
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.lineEdit_RegexPattern.setFont(font)
        ...
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.lineEdit_ReRepl.setFont(font)
        ...
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.lineEdit_ReReplCount.setFont(font)
        ...
        RenameToolUI.setTabOrder(self.tabwid, self.lineEdit_ReplSrc)
        RenameToolUI.setTabOrder(self.lineEdit_ReplSrc, self.lineEdit_ReplWith)
        RenameToolUI.setTabOrder(self.lineEdit_ReplWith, self.comboBox_InsertWith)
        ...
        RenameToolUI.setTabOrder(self.lineEdit_InsertPos, self.lineEdit_RReplLB)
        RenameToolUI.setTabOrder(self.lineEdit_RReplLB, self.checkBox_IncludeLB)
        RenameToolUI.setTabOrder(self.checkBox_IncludeLB, self.lineEdit_RReplRB)
        RenameToolUI.setTabOrder(self.lineEdit_RReplRB, self.checkBox_IncludeRB)
        RenameToolUI.setTabOrder(self.checkBox_IncludeRB, self.lineEdit_RReplWith)
        RenameToolUI.setTabOrder(self.lineEdit_RReplWith, self.comboBox_InExcExt)
        ...
        RenameToolUI.setTabOrder(self.comboBox_SpInf, self.btn_setrule_clear)
        RenameToolUI.setTabOrder(self.btn_setrule_clear, self.btn_SaveToList)
        ...
        RenameToolUI.setTabOrder(self.btn_RL_EditSelected, self.btn_RL_ClearAll)
        RenameToolUI.setTabOrder(self.btn_RL_ClearAll, self.plainText_ExcludeFolder)
        RenameToolUI.setTabOrder(self.plainText_ExcludeFolder, self.btn_chexcfile)
        RenameToolUI.setTabOrder(self.btn_chexcfile, self.btn_chexcfolder)
        RenameToolUI.setTabOrder(self.btn_chexcfolder, self.btn_ClearExcfd)
        RenameToolUI.setTabOrder(self.btn_ClearExcfd, self.lineEdit_TGPath)
        RenameToolUI.setTabOrder(self.lineEdit_TGPath, self.btn_CTGPath)
        RenameToolUI.setTabOrder(self.btn_CTGPath, self.btn_RL_AddToTaskList)
        ...
        RenameToolUI.setTabOrder(self.btn_TS_MoveDown, self.btn_TS_PrevSel)
        RenameToolUI.setTabOrder(self.btn_TS_PrevSel, self.btn_TS_PrevAll)
    ...
    def retranslateUi(self, RenameToolUI):
        ...
        self.lineEdit_ReplWith.setStatusTip(_translate("RenameToolUI", "此处留空则表示将删除前面填写的字符。"))
        self.tabwid.setTabText(self.tabwid.indexOf(self.tab_Repl), _translate("RenameToolUI", "替换"))
        self.label_13.setText(_translate("RenameToolUI", "插入："))
        self.comboBox_InsertWith.setStatusTip(_translate("RenameToolUI", "选择插入日期时间、者普通字符或者数字序号。"))
        ...
        self.lineEdit_InsertForm.setToolTip(_translate("RenameToolUI", "日期时间：%Y(年)、%y(年,两位数)、%m(月)、%d(日)、%H(时)、%M(分)、%S(秒)，可与普通字符自由组合。\n"
"数字序号：填写格式：<起始.步长.宽度>，可与普通字符组合，如 <0.1.3>~，则按 000~、001~、002~、003~…添加序号。"))
        self.lineEdit_InsertForm.setStatusTip(_translate("RenameToolUI", "具体用法请将鼠标置于本文本框上2秒以查看悬浮提示。"))
        self.lineEdit_InsertForm.setText(_translate("RenameToolUI", "[%Y-%m-%d]"))
        self.label_4.setText(_translate("RenameToolUI", "插入位置："))
        self.lineEdit_InsertPos.setStatusTip(_translate("RenameToolUI", "自定义位置支持输入百分比或绝对数值，如果输入的百分比或绝对数值大于文件名长度，则插入到文件名末尾，不支持负数。"))
        ...
        self.lineEdit_RReplLB.setStatusTip(_translate("RenameToolUI", "填写想要用来确定左边界的字符串(字符串越长匹配越准确)，左边界可以留空，留空时左边界默认为文件名最前端。"))
        self.checkBox_IncludeLB.setStatusTip(_translate("RenameToolUI", "是否包括左边界字符。"))
        self.checkBox_IncludeLB.setText(_translate("RenameToolUI", "包含"))
        self.label_6.setText(_translate("RenameToolUI", "右边界："))
        self.lineEdit_RReplRB.setStatusTip(_translate("RenameToolUI", "填写想要用来确定右边界的字符串(字符串越长匹配越准确)，右边界可以留空，留空时右边界默认为文件名末尾(默认不含扩展名)。"))
        self.checkBox_IncludeRB.setStatusTip(_translate("RenameToolUI", "是否包括右边界字符。"))
        self.checkBox_IncludeRB.setText(_translate("RenameToolUI", "包含"))
        self.label_7.setText(_translate("RenameToolUI", "边界内字符替换为："))
        self.lineEdit_RReplWith.setStatusTip(_translate("RenameToolUI", "此处留空则表示将删除范围内所有字符，注意此处和左右边界不能同时为空。"))
        self.tabwid.setTabText(self.tabwid.indexOf(self.tab_RRepl), _translate("RenameToolUI", "范围替换"))
        self.label_8.setText(_translate("RenameToolUI", "正则表达式："))
        self.lineEdit_RegexPattern.setStatusTip(_translate("RenameToolUI", "此模式需要掌握正则表达式写法。正则表达式匹配时单词模式不生效，可以自己写表达式来匹配单词。"))
        self.label_9.setText(_translate("RenameToolUI", "替换为："))
        self.lineEdit_ReRepl.setStatusTip(_translate("RenameToolUI", "要替换掉匹配字符的字符。"))
        self.label_15.setText(_translate("RenameToolUI", "替换次数："))
        self.lineEdit_ReReplCount.setStatusTip(_translate("RenameToolUI", "替换次数，0 代表全部替换。"))
        self.lineEdit_ReReplCount.setText(_translate("RenameToolUI", "0"))
        self.tabwid.setTabText(self.tabwid.indexOf(self.tab_Regex), _translate("RenameToolUI", "正则表达式"))
        self.comboBox_InExcExt.setStatusTip(_translate("RenameToolUI", "符合后面列出的扩展名的文件，限定只对其起作用或只对其不起作用。"))
        self.comboBox_InExcExt.setItemText(0, _translate("RenameToolUI", "指定文件格式"))
        self.comboBox_InExcExt.setItemText(1, _translate("RenameToolUI", "排除文件格式"))
        self.lineEdit_Exts.setStatusTip(_translate("RenameToolUI", "此处留空则表示将对所有扩展名的文件进行操作。"))
        self.lineEdit_Exts.setPlaceholderText(_translate("RenameToolUI", "多个扩展名请用空格隔开，例如：mp3 mp4 mkv。"))
        self.checkBox_Word.setStatusTip(_translate("RenameToolUI", "单词模式下，如果文件名以单词组成(以空格分开的词，包括中文)，则会按单词进行匹配，不会拆分单词。"))
        self.checkBox_Word.setText(_translate("RenameToolUI", "单词模式"))
        self.label_14.setStatusTip(_translate("RenameToolUI", "重命名文件时的作用范围，当扩展名中有符合匹配项时是否对扩展名进行操作。"))
        self.label_14.setText(_translate("RenameToolUI", "作用范围："))
        self.comboBox_SpInf.setStatusTip(_translate("RenameToolUI", "重命名文件时的作用范围，当扩展名中有符合匹配项时是否对扩展名进行操作。"))
        ...
        self.btn_setrule_clear.setStatusTip(_translate("RenameToolUI", "重置所有标签页的输入状态。"))
        self.btn_setrule_clear.setText(_translate("RenameToolUI", "清空输入"))
        self.btn_SaveToList.setStatusTip(_translate("RenameToolUI", "把当前标签页的输入信息打包成一条规则并保存到列表。"))
        self.btn_SaveToList.setText(_translate("RenameToolUI", "保存到规则列表"))
        self.groupBox_RuleList.setTitle(_translate("RenameToolUI", "规则列表"))
        self.list_RulesList.setStatusTip(_translate("RenameToolUI", "用户创建的重命名规则列表，同一规则可以多次与不同文件夹组合加入任务列表，或同一文件夹可以多次组合不同规则加入任务列表。"))
        self.btn_RL_DelSelected.setStatusTip(_translate("RenameToolUI", "删除选中的规则。"))
        self.btn_RL_DelSelected.setText(_translate("RenameToolUI", "删除"))
        self.btn_RL_EditSelected.setStatusTip(_translate("RenameToolUI", "编辑选中的规则，注意编辑完成后不要忘记重新保存到规则列表。"))
        self.btn_RL_EditSelected.setText(_translate("RenameToolUI", "编辑"))
        self.btn_RL_ClearAll.setStatusTip(_translate("RenameToolUI", "清空规则列表。"))
        self.btn_RL_ClearAll.setText(_translate("RenameToolUI", "清空"))
        self.label_12.setText(_translate("RenameToolUI", "排除文件和文件夹:"))
        self.plainText_ExcludeFolder.setStatusTip(_translate("RenameToolUI", "要排除的文件和文件夹请输入完整、正确路径，否则排除的文件或文件夹将不生效。"))
        self.plainText_ExcludeFolder.setPlaceholderText(_translate("RenameToolUI", "填写多个文件或文件夹时请每行填写一个文件或文件夹路径。"))
        self.btn_chexcfile.setStatusTip(_translate("RenameToolUI", "选择要排除的文件。"))
        self.btn_chexcfile.setText(_translate("RenameToolUI", "选择文件"))
        self.btn_chexcfolder.setStatusTip(_translate("RenameToolUI", "选择要排除的文件夹。"))
        self.btn_chexcfolder.setText(_translate("RenameToolUI", "选择文件夹"))
        self.btn_ClearExcfd.setStatusTip(_translate("RenameToolUI", "清空要排除的文件或文件夹列表。"))
        self.btn_ClearExcfd.setText(_translate("RenameToolUI", "清除全部"))
        self.label_11.setStatusTip(_translate("RenameToolUI", "要进行批量重命名操作的文件夹。"))
        self.label_11.setText(_translate("RenameToolUI", "目标文件夹:"))
        self.lineEdit_TGPath.setStatusTip(_translate("RenameToolUI", "要进行批量重命名操作的文件夹。"))
        self.btn_CTGPath.setStatusTip(_translate("RenameToolUI", "选择要进行批量重命名操作的文件夹。"))
        self.btn_CTGPath.setText(_translate("RenameToolUI", "…"))
        self.checkBox.setStatusTip(_translate("RenameToolUI", "未来得及完成的功能。"))
        self.checkBox.setText(_translate("RenameToolUI", "深入子目录"))
        self.btn_RL_AddToTaskList.setStatusTip(_translate("RenameToolUI", "将规则、排除的文件、文件夹、目标目录打包成一个任务加入到任务列表。"))
        self.btn_RL_AddToTaskList.setText(_translate("RenameToolUI", "将选中规则+目标+排除组合加入任务"))
        self.groupBox_Tasks.setTitle(_translate("RenameToolUI", "任务"))
        self.label_10.setText(_translate("RenameToolUI", "待执行任务 / 执行顺序:"))
        self.list_Tasks.setStatusTip(_translate("RenameToolUI", "等待执行的任务列表。"))
        self.btn_TS_Clear.setStatusTip(_translate("RenameToolUI", "清空任务列表。"))
        self.btn_TS_Clear.setText(_translate("RenameToolUI", "清空列表"))
        self.btn_TS_DelSelected.setStatusTip(_translate("RenameToolUI", "移除选中的任务。"))
        self.btn_TS_DelSelected.setText(_translate("RenameToolUI", "移除任务"))
        self.btn_TS_MoveUp.setStatusTip(_translate("RenameToolUI", "将选中任务上移。"))
        self.btn_TS_MoveUp.setText(_translate("RenameToolUI", "上移"))
        self.btn_TS_MoveDown.setStatusTip(_translate("RenameToolUI", "将选中任务下移。"))
        self.btn_TS_MoveDown.setText(_translate("RenameToolUI", "下移"))
        self.btn_TS_PrevSel.setStatusTip(_translate("RenameToolUI", "预览选中的任务的执行结果，在弹出的结果预览窗口中决定是否重命名。注意预览结果不代表最终结果，可能正式重命名过程中还会有重命名失败的文件。"))
        self.btn_TS_PrevSel.setText(_translate("RenameToolUI", "预览"))
        self.btn_TS_PrevAll.setStatusTip(_translate("RenameToolUI", "考虑到可能会有大量文件进行重命名造成性能问题，该功能暂不可用。"))
        ...
        self.list_Logs.setStatusTip(_translate("RenameToolUI", "重命名后生成的历史记录，可以提供有限的恢复功能。"))
        self.btn_LNR_ClearLog.setStatusTip(_translate("RenameToolUI", "删除选中的历史记录。"))
        self.btn_LNR_ClearLog.setText(_translate("RenameToolUI", "删除最早记录"))
        self.btn_LNR_ViewLog.setStatusTip(_translate("RenameToolUI", "查看选中的历史记录。"))
